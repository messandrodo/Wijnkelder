    ...
    <nav>
        <nav>
            <ul>
                ...
                <li><a ${param.current eq 'VindWijn'?"class = current":""} href="vindWijn.jsp">Zoek wijnen</a></li>
                <li><a ${param.current eq 'Logboek'?"class = current":""} href="Servlet?command=logboek">Persoonlijk Logboek</a></li>
            </ul>
        </nav>
    </nav>
</header>